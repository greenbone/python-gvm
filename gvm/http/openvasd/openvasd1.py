...
class OpenvasdHttpApiV1(GvmHttpApi):
    ...
    def get_health_alive(self, *, raise_for_status: bool = False) -> HttpResponse:
        """
        ...
        """
        return self._connector.get("/health/alive", raise_for_status=raise_for_status)
    ...
    def get_health_ready(self, *, raise_for_status: bool = False) -> HttpResponse:
        ...
        """
        return self._connector.get("/health/ready", raise_for_status=raise_for_status)

    def get_health_started(self, *, raise_for_status: bool = False) -> HttpResponse:
        """
        ...
        """
        return self._connector.get("/health/started", raise_for_status=raise_for_status)

    def get_notus_os_list(self, *, raise_for_status: bool = False) -> HttpResponse:
        """
    ...
    def run_notus_scan(self, os: str, package_list: list[str], *, raise_for_status: bool = False) -> HttpResponse:
        """
        ...
        return self._connector.post_json(f"/notus/{quoted_os}", package_list, raise_for_status=raise_for_status)

    def get_scan_preferences(self, *, raise_for_status: bool = False) -> HttpResponse:
        """
        ...
        """
        return self._connector.get("/scans/preferences", raise_for_status=raise_for_status)
    ...
    def create_scan(
        ...
        *,
        ...
        return self._connector.post_json("/scans", request_json, raise_for_status=raise_for_status)

    def delete_scan(self, scan_id: str, *, raise_for_status: bool = False) -> HttpResponse:
        """
        ...
        return self._connector.delete(f"/scans/{quoted_scan_id}", raise_for_status=raise_for_status)
    ...
    def get_scan(self, scan_id: str, *, raise_for_status: bool = False) -> HttpResponse:
        """
        ...
        """
        quoted_scan_id = urllib.parse.quote(scan_id)
        return self._connector.get(f"/scans/{quoted_scan_id}", raise_for_status=raise_for_status)
        ...
        *,
        ...
        if range_start is not None:
            if not isinstance(range_start, int):
                raise InvalidArgumentType(argument="range_start", function=self.get_scan_results.__name__)

            if range_end is not None:
                if not isinstance(range_end, int):
                    raise InvalidArgumentType(argument="range_end", function=self.get_scan_results.__name__)
    ...
    def get_scan_status(self, scan_id: str, *, raise_for_status: bool = False) -> HttpResponse:
        """
        Gets a scan with the given id.
        ...
        """
        quoted_scan_id = urllib.parse.quote(scan_id)
        return self._connector.get(f"/scans/{quoted_scan_id}/status", raise_for_status=raise_for_status)

    def run_scan_action(self, scan_id: str, scan_action: str, *, raise_for_status: bool = False) -> HttpResponse:
        """
        ...
        return self._connector.post_json(f"/scans/{quoted_scan_id}", action_json, raise_for_status=raise_for_status)

    def start_scan(self, scan_id: str, *, raise_for_status: bool = False) -> HttpResponse:
        """
        ...
        Return:
            The HTTP response. See POST /scans/{id} in the openvasd API documentation.
        """
        return self.run_scan_action(scan_id, "start", raise_for_status=raise_for_status)

    def stop_scan(self, scan_id: str, *, raise_for_status: bool = False) -> HttpResponse:
        """
        ...
        Return:
            The HTTP response. See POST /scans/{id} in the openvasd API documentation.
        """
        return self.run_scan_action(scan_id, "stop", raise_for_status=raise_for_status)
    ...
    def get_vt(self, oid: str, *, raise_for_status: bool = False) -> HttpResponse:
        """
        ...
        return self._connector.get(f"/vts/{quoted_oid}", raise_for_status=raise_for_status)
