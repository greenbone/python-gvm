...
class ScanReports:
    ...
    def export_delta_scan_report(
        ...
        *,
        ...
        """Request an asynchronous export of a delta scan report.
        ...
        Returns:
            A request for the export_delta_scan_report GMP command.
        ...
        if not report_id:
            raise RequiredArgument(
                function=cls.export_delta_scan_report.__name__,
                argument="report_id",
            )
        ...
        cmd = XmlCommand("export_delta_scan_report")
        cmd.set_attribute("report_id", str(report_id))
